...
-- Modelo físico do banco de dados (PostgreSQL)
-- Baseado no modelo lógico definido na Etapa A2 (item 2.1.9)
-- =========================================================

-- 1. USUÁRIOS (administradores do sistema)
...
CREATE TABLE IF NOT EXISTS agendamentos (
  ...
  id_barbeiro      INTEGER NOT NULL
                   REFERENCES barbeiros(id_barbeiro) ON DELETE RESTRICT,
...
-- Impede, no próprio banco, dois agendamentos ativos no mesmo barbeiro/data/horário
...
-- TRIGGER — impede conflito de horário ao inserir um agendamento
